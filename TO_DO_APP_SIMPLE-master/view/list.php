<div class="col shadow main-col bg-white">
  <div class="row bg-primary text-white">
    ...
    <div class="col">
      ...
      <a href="index.php?action=chng_email"><b style="color:white;">change email</b></a>
      <a href="index.php?action=chng_pw"><b style="color:white;">change password</b></a>
  ...
  <div class="row" id="todo-container">
    ...
    <?php
            ...
            if(is_admin(user_get_logged_user())=='Yes'){

          ?>

<button type="submit" class="btn btn-primary mb-2 ml-2" onclick="location='index.php?action=show_stat'">
        <?php echo LANG_ADMINSETUP;?>
      </button>
      <?php
            }
      ?>
